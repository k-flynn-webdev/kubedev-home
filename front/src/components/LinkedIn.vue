	...
	<cbutton 
		...
		v-bind:title=title>
			...
			<svg width="100%" height="100%" viewBox="0 0 116 116" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
				...
				<g id="icon_linked">
					<g>
						<path d="M39.608,91.735l-9.795,0l0,-43.617l9.795,0l0,43.617Zm-10.4,-54.944c0,-1.505 0.477,-2.755 1.431,-3.749c0.954,-0.994 2.318,-1.492 4.092,-1.492c1.773,0 3.144,0.498 4.111,1.492c0.968,0.994 1.452,2.244 1.452,3.749c0,1.478 -0.484,2.708 -1.452,3.688c-0.967,0.981 -2.338,1.472 -4.111,1.472c-1.774,0 -3.138,-0.491 -4.092,-1.472c-0.954,-0.98 -1.431,-2.21 -1.431,-3.688Z" style="fill-rule:nonzero;"/>
						<path d="M59.361,48.118l0.282,5.039c3.225,-3.896 7.457,-5.845 12.698,-5.845c9.083,0 13.706,5.2 13.867,15.601l0,28.822l-9.796,0l0,-28.258c0,-2.768 -0.598,-4.817 -1.793,-6.148c-1.196,-1.33 -3.151,-1.995 -5.866,-1.995c-3.95,0 -6.893,1.787 -8.828,5.361l0,31.04l-9.796,0l0,-43.617l9.232,0Z" style="fill-rule:nonzero;"/>
					</g>
...
export default {
	...
	data(){
		return {
			link : 'https://www.linkedin.com/in/kevin-flynn-57988a2/',
			title : 'Linkedin',
		}
	},
	components: {
